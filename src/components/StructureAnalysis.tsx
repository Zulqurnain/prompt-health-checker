...
const components: Array<{ key: keyof StructureComponents; label: string; description: string }> = [
    ...
    <div className="bg-slate-900/60 border border-slate-700/50 rounded-2xl p-6">
      <div className="flex items-center justify-between mb-5">
        ...
        <span className="text-xs text-slate-500">
          {presentCount} / {components.length} detected
        </span>
      </div>
          ...
          return (
            ...
            >
              <div className={clsx(
                ...
                present ? "bg-emerald-500/25" : "bg-slate-700/60"
              )}>
                {present ? (
              ...
              <div className="min-w-0">
                ...
                <div className={clsx("text-[10px] mt-0.5", present ? "text-emerald-400/70" : "text-slate-600")}>
                  {description}
                </div>
              </div>
            </div>
